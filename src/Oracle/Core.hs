...
mkOracleValidator oracle x r ctx =
  ...
  where
    ...
    -- needs to be updated - we might have more than one output
    -- when nfts are "sold" from the oracle
    ownOutput :: TxOut
    ...
    -- will probably become more complex with different fees for 
    -- different listed property nfts
    feesPaid :: Bool
    feesPaid =
      let
...
data OracleParams = OracleParams
    ...
    , opToken  :: !TokenName --this will become a map of sorts holding all nfts, sold and unsold
